# <h1 align="center">🎟 INGRESSO ONLINE</h1>
...
<p align="center">Este código JavaScript gerencia a compra de ingressos para diferentes setores de um evento. O usuário seleciona o tipo de ingresso e a quantidade desejada. As funções correspondentes verificam se há disponibilidade suficiente, exibindo um alerta em caso contrário. Se a quantidade é válida, ela é subtraída da quantidade total disponível no documento.</p>
<blockquote> Projeto Concluído :heavy_check_mark:</blockquote>

<h2 align="center" id="tecnicas">👨‍💻 Técnicas utilizadas</h2>
<p align="center">
Manipulação do DOM &bull; Estruturas condicionais &bull; Manipulação de variáveis &bull; Exibição de alertas
</p>
